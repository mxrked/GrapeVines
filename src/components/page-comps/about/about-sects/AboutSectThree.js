...
const AboutSectThree = () => {
  return (
    <div id="aboutSectThree" className="about-sect">
      <div className="container-fluid about-sect-box page-transition">
        <div className="row about-sect-row page-transition">
          ...
          <div
            className="col-lg-5 col-md-6 col-sm-4 col-xs-12 about-sect-side page-transitiona-fade"
            data-aos="fade-left"
            data-aos-delay="400"
            data-aos-duration="400"
          >
            <div className="about-sect-bgs">
              <div
                ...
                data-bg="http://basicallyeasy.com/Website CDNS/REACTCDNS/GrapeVines/about/sects/sect-3/sect-3-bg-1.jpg"
              ></div>
              <div
                className="about-sect-bg sm-bg lazyload"
                data-bg="http://basicallyeasy.com/Website CDNS/REACTCDNS/GrapeVines/about/sects/sect-3/sect-3-bg-2.jpg"
              ></div>
            </div>
          </div>
        </div>
